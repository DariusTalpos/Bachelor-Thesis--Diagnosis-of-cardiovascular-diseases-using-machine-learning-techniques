...
<p>EN: This repository contains my Bachelor's Thesis, titled "Diagnosis of cardiovascular diseases using machine learning techniques". Its four main components are the following: </p>
<o1>
  <li>The Bachelor's Thesis itself, in the PDF format</li>
  <li>The presentation of the thesis</li>
  <li>HeartVitality</li>
  <li>DefaultModelGenerator</li>
</o1>

<p>RO: This repository contains my Bachelor's Thesis, titled "Diagnosis of cardiovascular diseases using machine learning techniques". Its four main components are the following: </p>
<o1>
  <li>The Bachelor's Thesis itself, in the PDF format</li>
  <li>The presentation of the thesis</li>
  <li>HeartVitality</li>
